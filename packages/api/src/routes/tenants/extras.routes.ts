/**
 * MÓDULO DE RUTAS EXTRAS - Rutas legacy que el frontend espera directamente
 *
 * Este módulo maneja rutas que el frontend llama directamente sin prefijo de módulo:
 * - /amenidades - Gestión de amenidades del tenant
 * - /idiomas - Idiomas habilitados del tenant
 * - /comision-config - Configuración de comisiones
 *
